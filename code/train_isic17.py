...
if __name__ == '__main__':
    ...
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_small      # OVER6
    ...
    """ efficient scan"""
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK           # OVER4
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK_small     # OVER3

    """ atrous ss2d scan"""
    # config = setting_config_atrousv2_ULPSR_ss2d_CNN_SE_SK             # OVER10
    # config = setting_config_atrousv2_ULPSR_ss2d_CNN_SE_SK_small       # OVER2

    """ ss2d """
    # config = setting_config_ULPSR_ss2d_CNN_SE_SK          # OVER2
    # config = setting_config_ULPSR_ss2d_CNN_SE_SK_small    # OVER4
    ...
    # config = setting_config_ULP_small                     # OVER2
    ...
    # config = setting_config_atrousv2_ULPSR_CNN_small      # OVER3
    ...
    config = setting_config_atrousv2_ULPSR_step222224_CNN_SE_SK_small         # OVER2
