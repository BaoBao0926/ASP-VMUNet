...
from configs.isic18.config_setting_atrous import *
from configs.isic18.config_setting_other_network import *
...
def main(config):
    ...
    val_dataset = Isic_datasets(config.data_path, config, train=False, test_dataset='isic18')
    ...
    val_loader_dict['isic18'] = val_loader
    ...
    if config.network == 'atrous_UL_CNN':
        ...
        print('this is for atrous UL CNN structure [2,2,2,2,18,2]')
    ...
    if os.path.exists(resume_model):
        ...
        min_loss, min_epoch, loss, max_dsc = checkpoint['min_loss'], checkpoint['min_epoch'], checkpoint['loss'], \
                                             checkpoint['max_dsc']
...
if __name__ == '__main__':
    ...
    """ out model """
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK            # OVER8
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_small      # OVER4
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_big        # OVER2

    """ vallian scan """
    # config = setting_config_vallian_ULPSR_CNN_SE_SK                   # OVER2
    # config = setting_config_vallian_ULPSR_CNN_SE_SK_small             # OVER2

    """ efficient scan"""
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK           # OVER2
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK_small     # OVER5

    """ atrous ss2d scan"""
    # config = setting_config_atrousv2_ULPSR_ss2d_CNN_SE_SK             # OVER4
    # config = setting_config_atrousv2_ULPSR_ss2d_CNN_SE_SK_small       # OVER2

    """ ss2d """
    # config = setting_config_ULPSR_ss2d_CNN_SE_SK          # OVER2
    # config = setting_config_ULPSR_ss2d_CNN_SE_SK_small    # OVER2

    """structure ablation study"""
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_small_stru2      # OVER2
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_small_stru18     # OVER2

    """ component ablation study"""
    # config = setting_config_ULP_small                     # OVER1
    # config = setting_config_ULPS_small                    # OVER1
    # config = setting_config_ULPSR_small                   # OVER2
    # config = setting_config_atrousv2_ULPSR_small          # OVER2
    # config = setting_config_atrousv2_ULPSR_CNN_small      # OVER2
    # config = setting_config_atrousv2_ULPSR_CNN_SE_small   # OVER2
    # config = setting_config_atrousv2_ULPSR_CNN_SK_small   # OVER2
    ...
    # config = setting_config_atrousv2_ULPSR_step8_CNN_SE_SK_small                  # OVER4
    ...
    config = setting_config_atrousv2_ULPSR_step222221_CNN_SE_SK_small             # OVER2
    # config = setting_config_atrousv2_ULPSR_step222224_CNN_SE_SK_small             # OVER4
