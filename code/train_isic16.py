...
from configs.isic16.config_setting_atrous import *
from configs.isic16.config_setting_other_network import *
...
if __name__ == '__main__':
    ...
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_small      # OVER8
    # config = setting_config_atrousv2_ULPSR_step2_CNN_SE_SK_big        # OVER4

    """ Vallian Scan"""
    # config = setting_config_vallian_ULPSR_CNN_SE_SK                   # OVER3
    # config = setting_config_vallian_ULPSR_CNN_SE_SK_small             # OVER2

    """ efficient scan"""
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK           # OVER2
    # config = setting_config_efficient_ULPSR_step2_CNN_SE_SK_small     # OVER2
    ...
    # config = setting_config_ULP_small                     # OVER4
    ...
    # config = setting_config_atrousv2_ULPSR_CNN_SK_small   # OVER6
    ...
    # config = setting_config_atrousv2_ULPSR_step12_CNN_SE_SK_small             # OVER3
